...
@Component({
  selector: 'tds-snackbar',
  templateUrl: './tds-snackbar.component.html',
  styleUrl: './tds-snackbar.component.scss',
})
export class TDSSnackbarComponent implements OnInit {
  public snackbarData!: TDSSnackbarData;

  constructor(
    private eleRef: ElementRef,
    private snackbarService: TDSSnackbarService
  ) {}

  ngOnInit() {
    this.snackbarService.snackbar$
      .pipe(
        tap((snackbarData: TDSSnackbarData) => {
  ...
  private open(snackbarData: TDSSnackbarData) {
